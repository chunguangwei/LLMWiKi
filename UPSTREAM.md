...
| Upstream 版本号 | `0.5.0`（Round 3 追平：providers / embeddings+LanceDB / 摄取质量 / 审阅 / 渲染 / 稳定性 / 关系图性能 / MiniMax M3 / Lint 链接修复 / Firecrawl / 界面缩放 / MinerU / 托盘+自启 / MCP 打包 / 聊天独立视图）|
| **本 fork 版本** | `0.5.0`（追平上游 v0.5.0：聊天 Agent 路由[替换我方实验版] + Atlas Cloud + Intel macOS 构建；叠加 fork 的 GitHub 备份等）|
